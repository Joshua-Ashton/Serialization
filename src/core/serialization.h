...
public:
  ...
  static inline istream &read_internal(istream &istream_, char *p,
                                       uint32_t size) {
  ...
  static inline ostream &write_internal(ostream &ostream_, const char *p,
                                        uint32_t size) {
  ...
  template <typename T> static inline istream &read(istream &istream_, T &t_) {
  ...
  template <typename T> static inline ostream &write(ostream &ostream_, T &t_) {
    if (std::is_fundamental<T>::value) {
